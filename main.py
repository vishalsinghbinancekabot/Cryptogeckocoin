...
COINS = [
    # 🔹 Mega Caps
    "ADAUSDT",  "BNBUSDT", "BTCUSDT", "DOGEUSDT", "DOTUSDT", "ETHUSDT", "LTCUSDT", "MATICUSDT",
    "NEARUSDT", "SHIBUSDT", "SOLUSDT", "TRXUSDT", "UNIUSDT", "XLMUSDT", "XRPUSDT", "ATOMUSDT", "LUNAUSDT",

    # 🔸 Layer-1 & Layer-2
    "ALGOUSDT", "ANKRUSDT", "APTUSDT", "ARBUSDT", "BSCUSDT", "CELRUSDT", "CSPRUSDT", "ELFUSDT", "FETUSDT", 
    "ICPUSDT", "KAVAUSDT", "KLAYUSDT", "MINAUSDT", "OPUSDT", "RUNEUSDT", "STXUSDT", "SUIUSDT",  
    ...
    # 🚀 Meme & Viral Tokens
    "BONKUSDT", "FLOKIUSDT", "GALUSDT", "HATIUSDT", "KOISHIUSDT", "NOTUSDT", "PEPEUSDT", "SNOUSDT", "WIFUSDT",
